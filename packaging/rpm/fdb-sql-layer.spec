...
ln -s /usr/share/foundationdb/sql/routine-firewall/%{_fdb_sql_layer_rf_jar} "${RPM_BUILD_ROOT}/usr/share/foundationdb/sql/routine-firewall/routine-firewall.jar"
