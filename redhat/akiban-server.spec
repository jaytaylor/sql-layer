...
cp -p target/akiban-server-1.6.0.jar ${RPM_BUILD_ROOT}/usr/share/%{username}
ln -s /usr/share/%{username}/akiban-server-1.6.0.jar ${RPM_BUILD_ROOT}/usr/share/%{username}/akiban-server.jar
cp -p target/dependency/* ${RPM_BUILD_ROOT}/usr/share/%{username}/server
cp -p redhat/akiban-client-tools-1.3.5.jar ${RPM_BUILD_ROOT}/usr/share/%{username}
ln -s /usr/share/%{username}/akiban-client-tools-1.3.5.jar ${RPM_BUILD_ROOT}/usr/share/%{username}/akiban-client-tools.jar
