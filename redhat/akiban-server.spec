...
cp -p target/akiban-server-1.6.2-SNAPSHOT.jar ${RPM_BUILD_ROOT}/usr/share/%{username}
ln -s /usr/share/%{username}/akiban-server-1.6.2-SNAPSHOT.jar ${RPM_BUILD_ROOT}/usr/share/%{username}/akiban-server.jar
