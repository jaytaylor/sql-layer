...
cp -p target/akiban-server-1.4.3.jar ${RPM_BUILD_ROOT}/usr/share/%{username}
ln -s /usr/share/%{username}/akiban-server-1.4.3.jar ${RPM_BUILD_ROOT}/usr/share/%{username}/akiban-server.jar
