...
public enum ErrorCode {
    ...
    LOB_EXCEPTION           ("22", "509", Importance.DEBUG, LobException.class),
    ...
    AUTO_GENERATED_KEYS_FROM_SELECT      ("42", "900", Importance.DEBUG, AutoGeneratedKeysFromSelectException.class),
    AUTO_GENERATED_KEYS_WITH_RETURNING   ("42", "901", Importance.DEBUG, AutoGeneratedKeysWithReturningException.class),
    PARAMETER_NOT_FOUND                  ("42", "902", Importance.DEBUG, ParameterNotFoundException.class),
    AUTO_COMMIT_USAGE                    ("42", "903", Importance.DEBUG, AutoCommitUsageException.class),
    BAD_CURSOR_STATE                     ("42", "904", Importance.DEBUG, BadCursorStateException.class),
