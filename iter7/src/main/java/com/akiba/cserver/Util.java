...
public class Util {
    ...
    public static int putBytes(byte[] bytes, int index, byte[] value, int offset, int length)
    {
    ...
    public static void printRuntimeInfo() {
    	System.out.println();
		RuntimeMXBean m = java.lang.management.ManagementFactory.getRuntimeMXBean();
		...
		System.out.println("ManagementSpecVersion = " + m.getManagementSpecVersion());
		...
		System.out.println("BootClassPathSupported = " + m.isBootClassPathSupported());
