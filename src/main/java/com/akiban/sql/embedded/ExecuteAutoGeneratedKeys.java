...
{
    public abstract int[] getTargetColumns(UserTable targetTable) throws SQLException;
    ...
    static ExecuteAutoGeneratedKeys of(int autoGeneratedKeys) {
        ...
        case Statement.RETURN_GENERATED_KEYS:
            return new ExecuteAutoGeneratedKeys() {
                    @Override
                    public int[] getTargetColumns(UserTable targetTable) {
                        Column identityColumn = targetTable.getIdentityColumn();
                        if (identityColumn == null)
                            return new int[] { };
                        else
                            return new int[] { identityColumn.getPosition() };
                    }
                };
        default:
    ...
    static ExecuteAutoGeneratedKeys of(final int[] columnIndexes) {
        return new ExecuteAutoGeneratedKeys() {
                @Override
                public int[] getTargetColumns(UserTable targetTable) throws SQLException {
                    int[] result = new int[columnIndexes.length];
