...
public class PostgresType extends ServerType
{
    ...
    public enum TypeOid {
        ...
        BOOL_TYPE_OID(16, "bool", BinaryEncoding.C_BOOLEAN),
        BYTEA_TYPE_OID(17, "bytea", BinaryEncoding.BINARY_OCTAL_TEXT),
        CHAR_TYPE_OID(18, "char"),
        NAME_TYPE_OID(19, "name"),
        INT8_TYPE_OID(20, "int8", BinaryEncoding.INT64),
        INT2_TYPE_OID(21, "int2", BinaryEncoding.INT16),
        INT2VECTOR_TYPE_OID(22, "int2vector"),
        INT4_TYPE_OID(23, "int4", BinaryEncoding.INT32),
        ...
        FLOAT4_TYPE_OID(700, "float4", BinaryEncoding.FLOAT32),
        FLOAT8_TYPE_OID(701, "float8", BinaryEncoding.FLOAT64),
        ...
        TIMESTAMP_TYPE_OID(1114, "timestamp", BinaryEncoding.FLOAT64_SECS_2000_NOTZ),
