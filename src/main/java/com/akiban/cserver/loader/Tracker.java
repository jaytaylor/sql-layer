...
public class Tracker
{
    ...
    private static final String TEMPLATE_CREATE_PROGRESS_TABLE =
        "create table %s.progress(" +
        ...
        ")";
    private static final String TEMPLATE_LOG_PROGRESS =
        "insert into %s.progress(time, event_time_sec, message) values (now(), %s, '%s')";
    private static final String TEMPLATE_RECENT_EVENTS =
        "select event_id, time, event_time_sec, message " +
        "from %s.progress " +
        "where event_id > %s";
