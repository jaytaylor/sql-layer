...
public class BulkLoaderTest extends TestCase
{
    ...
    public void testCOI() throws Exception
    {
        ...
        builder.column("schema", "customer", "cid", 0, "int", 0L, 0L, false, false);
        builder.column("schema", "customer", "customer_name", 1, "varchar", 64L, 0L, false, false);
        builder.index("schema", "customer", "customer_pk", true, "PRIMARY KEY");
        builder.indexColumn("schema", "customer", "customer_pk", "cid", 0, true);
        builder.userTable("schema", "order");
        builder.column("schema", "order", "oid", 0, "int", 0L, 0L, false, false);
        builder.column("schema", "order", "cid", 1, "int", 0L, 0L, false, false);
        builder.column("schema", "order", "order_date", 2, "int", 0L, 0L, false, false);
        ...
        builder.column("schema", "item", "quantity", 2, "int", 0L, 0L, false, false);
        ...
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "customer"),
                            ...
                            actions.hKey);
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "item").getParentJoin()),
                            actions.noHKey);
    }
    ...
    public void testCOIWithCascadingKeys() throws Exception
    {
        ...
        builder.column("schema", "item", "quantity", 3, "int", 0L, 0L, false, false);
        builder.index("schema", "item", "item_pk", true, "PRIMARY KEY");
    ...
    public void testCOIA() throws Exception
    {
        ...
        builder.column("schema", "address", "aid", 0, "int", 0L, 0L, false, false);
        builder.column("schema", "address", "cid", 1, "int", 0L, 0L, false, false);
        builder.column("schema", "address", "line1", 2, "varchar", 100L, 0L, false, false);
        builder.column("schema", "address", "line2", 3, "varchar", 100L, 0L, false, false);
        ...
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "customer"),
                                          ais.getUserTable("schema", "order"),
                                          ais.getUserTable("schema", "address")),
                            actions.hKey);
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "item").getParentJoin()),
                            actions.noHKey);
    }
    ...
    public void testCOIX() throws Exception
    {
        ...
        builder.joinColumns("ix", "schema", "item", "iid", "schema", "x", "iid");
        builder.basicSchemaIsComplete();
        builder.createGroup("group", "groupschema", "coi");
        builder.addJoinToGroup("group", "co", 0);
        builder.addJoinToGroup("group", "oi", 0);
        ...
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "customer"),
                            ...
                            actions.hKey);
        Assert.assertEquals(Arrays.asList(ais.getUserTable("schema", "item").getParentJoin(),
                                          ais.getUserTable("schema", "x").getParentJoin()),
                            actions.noHKey);
    }
