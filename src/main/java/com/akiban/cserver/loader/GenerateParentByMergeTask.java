...
public class GenerateParentByMergeTask extends GenerateParentTask
{
    ...
    {
        super(loader, table);
        // Merged table contains columns of parent and columns of child that don't participate in the join.
        addColumns(parentTask.columns());
        List<Column> childNonFKColumns = new ArrayList<Column>(childTask.columns());
