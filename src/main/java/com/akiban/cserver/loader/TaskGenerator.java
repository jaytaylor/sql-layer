...
public class TaskGenerator
{
    ...
    public IdentityHashMap<UserTable, TableTasks> generateTasks() throws Exception
    {
    ...
    private void generateTasks(List<Column> hKeyColumns, Join join) throws Exception
    {
        ...
        if (hKeyColumns.size() > 0 && childHKeyColumns.size() == hKeyColumns.size()) {
            // Every hkey column in the parent has a counterpart in the child via the join. So the child table
            // has a complete hkey.
