...
public class NoResourceHandler extends DefaultHandler {
    ...
    public void handle(String target,
        ...
        RestResponseBuilder.formatJsonError(builder, ErrorCode.MALFORMED_REQUEST.getFormattedValue(), "Path not supported");
        builder.append('\n');
...
/*    
    ...
    public Response handleNoResource(@Context HttpServletRequest request) {
        return RestResponseBuilder
                ...
                .body(ErrorCode.MALFORMED_REQUEST, "Path not supported")
                .build();
    }
*/    
}
