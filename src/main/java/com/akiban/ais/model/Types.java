...
public class Types {
	...
	public static Type POINT =              new Type("point", 0, false, 0L, "POINT", AkType.UNSUPPORTED, null);
	public static Type MULTIPOINT =         new Type("multipoint", 0, false, 0L, "MULTIPOINT", AkType.UNSUPPORTED, null);
	public static Type LINESTRING =         new Type("linestring", 0, false, 0L, "LINESTRING", AkType.UNSUPPORTED, null);
	public static Type MULTILINESTRING =    new Type("multilinestring", 0, false, 0L, "MULTILINESTRING", AkType.UNSUPPORTED, null);
