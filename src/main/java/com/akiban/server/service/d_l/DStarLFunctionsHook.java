...
public interface DStarLFunctionsHook {
    ...
    static enum DDLFunction {
        CREATE_TABLE(DStarLType.DDL_FUNCTIONS),
        DROP_TABLE(DStarLType.DDL_FUNCTIONS),
        DROP_SCHEMA(DStarLType.DDL_FUNCTIONS),
        DROP_GROUP(DStarLType.DDL_FUNCTIONS),
        GET_AIS(DStarLType.DDL_FUNCTIONS),
        GET_TABLE_ID(DStarLType.DDL_FUNCTIONS),
        GET_TABLE_BY_ID(DStarLType.DDL_FUNCTIONS),
        GET_TABLE_BY_NAME(DStarLType.DDL_FUNCTIONS),
        GET_USER_TABLE_BY_NAME(DStarLType.DDL_FUNCTIONS),
        GET_USER_TABLE_BY_ID(DStarLType.DDL_FUNCTIONS),
        GET_ROWDEF(DStarLType.DDL_FUNCTIONS),
        GET_DDLS(DStarLType.DDL_FUNCTIONS),
        GET_SCHEMA_ID(DStarLType.DDL_FUNCTIONS),
        FORCE_GENERATION_UPDATE(DStarLType.DDL_FUNCTIONS),
        CREATE_INDEXES(DStarLType.DDL_FUNCTIONS),
        DROP_INDEXES(DStarLType.DDL_FUNCTIONS),
