...
public final class AkIntervalMonths extends IntervalBase {

    /**
     * An MONTHS interval. Its underlying INT_64 represents months.
     */
    public static IntervalBase DAYS = new AkIntervalMonths();
