...
public final class AkCompressIntComplex extends TOverloadBase {
    @Override
    ...
    protected void doEvaluate(TExecutionContext context, LazyList<? extends PValueSource> inputs, PValueTarget output) {
        long asLong = inputs.get(0).getInt64();
        TClass tClass = context.outputTInstance().typeClass();
        ...
        case INT_32:
            ...
            break;
        case INT_64:
            assert tClass == AkNumeric.BIGINT : tClass;
            output.putInt64(asLong);
            break;
        default:
    ...
    public TOverloadResult resultType() {
        return new TOverloadResult(new Function<List<TPreptimeValue>, TInstance>() {
            @Override
            public TInstance apply(List<TPreptimeValue> input) {
