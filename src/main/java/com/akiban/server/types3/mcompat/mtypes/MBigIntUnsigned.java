...
public class MBigIntUnsigned extends TClass {

    public static MBigIntUnsigned INSTANCE = new MBigIntUnsigned(); 
    ...
    public MBigIntUnsigned() {
        super(MBundle.INSTANCE.id(), "bigint", new String[]{"M"}, 1, 1, 8);
    }
