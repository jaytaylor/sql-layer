...
public abstract class MExtractDate extends TOverloadBase {

    public static final TOverload YEAR = new MExtractDate() {
    ...
    public static final TOverload MONTH = new MExtractDate() {
    ...
    public static final TOverload DAY = new MExtractDate() {
