...
public class MAbs {
    ...
    public static final Abs TINYINT = new Abs(MNumeric.TINYINT) {
    ...
    public static final Abs SMALLINT = new Abs(MNumeric.SMALLINT) {
    ...
    public static final Abs MEDIUMINT = new Abs(MNumeric.MEDIUMINT) {
    ...
    public static final Abs BIGINT = new Abs(MNumeric.BIGINT) {
    ...
    public static final Abs INT = new Abs(MNumeric.INT) {
    ...
    public static final Abs DECIMAL = new Abs(MNumeric.DECIMAL) {
    ...
    public static final Abs DOUBLE = new Abs(MDouble.INSTANCE) {
