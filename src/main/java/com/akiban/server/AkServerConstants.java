...
//    public final static short NOT_REALLY_AN_ERROR_ERROR = 42; //TODO
    ...
    public final static int DEFAULT_AKSERVER_PORT = 5140;
    public final static String DEFAULT_AKSERVER_HOST_STRING = "0.0.0.0";
    public final static String DEFAULT_AKSERVER_PORT_STRING = Integer.toString(DEFAULT_AKSERVER_PORT);
