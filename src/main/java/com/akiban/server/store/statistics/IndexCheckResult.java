...
public final class IndexCheckResult implements Serializable {
    ...
    public String toString() {
        return String.format("%s: %s expected %s, saw %s", getBottomLine(), indexName, expectedCount, sawCount);
    }

    IndexCheckResult(IndexName indexName, long expectedCount, long sawCount, long verifiedCount) {
