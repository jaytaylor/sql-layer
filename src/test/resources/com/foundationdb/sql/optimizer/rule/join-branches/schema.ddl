CREATE TABLE parent0(id INT NOT NULL, PRIMARY KEY(id));
CREATE TABLE child0(id INT NOT NULL, PRIMARY KEY(id), pid INT, GROUPING FOREIGN KEY(pid) REFERENCES parent0(id));
