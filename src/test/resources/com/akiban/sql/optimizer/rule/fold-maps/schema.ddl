...
CREATE TABLE t1(id INT PRIMARY KEY NOT NULL, s VARCHAR(10));
CREATE TABLE t2(id INT PRIMARY KEY NOT NULL, s VARCHAR(10));
CREATE TABLE t3(id INT PRIMARY KEY NOT NULL, s VARCHAR(10));
