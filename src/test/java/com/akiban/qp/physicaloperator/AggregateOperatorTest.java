...
public final class AggregateOperatorTest {
    ...
    public void simpleNoGroupBy() {
        ...
        PhysicalOperator plan = new Aggregate_Partial(input, 0, FACTORY, TestFactory.FUNC_NAMES, rowType);
    ...
    public void simpleWithGroupBy() {
        ...
        AggregatedRowType rowType = new AggregatedRowType(null, 1, input.rowType());
        PhysicalOperator plan = new Aggregate_Partial(input, 1, FACTORY, TestFactory.FUNC_NAMES, rowType);
    ...
    public void twoColumnGroupBy() {
        ...
        AggregatedRowType rowType = new AggregatedRowType(null, 1, input.rowType());
        PhysicalOperator plan = new Aggregate_Partial(input, 2, FACTORY, TestFactory.FUNC_NAMES, rowType);
