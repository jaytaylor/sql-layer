...
public final class AggregateOperatorTest {
    ...
    public void simpleNoGroupBy() {
        ...
        Operator plan = new Aggregate_Partial(input, 0, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    ...
    public void simpleWithGroupBy() {
        ...
        AggregatedRowType rowType = new AggregatedRowType(null, 1, input.rowType());
        Operator plan = new Aggregate_Partial(input, 1, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    ...
    public void twoColumnGroupBy() {
        ...
        AggregatedRowType rowType = new AggregatedRowType(null, 1, input.rowType());
        Operator plan = new Aggregate_Partial(input, 2, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    ...
    public void invalidRowTypes() {
        ...
        try {
            ...
            AggregatedRowType rowType = new AggregatedRowType(null, 1, input.rowType());
            plan = new Aggregate_Partial(input, 1, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
        } catch (Exception e) {
    ...
    public void inputIsNull() {
        ...
        new Aggregate_Partial(null, 1, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    }
    ...
    public void factoryIsNull() {
        ...
        new Aggregate_Partial(input, 1, null, TestRegistry.FUNC_NAMES, rowType);
    }
    ...
    public void listsNameIsNull() {
        ...
        new Aggregate_Partial(input, 1, REGISTRY, null, rowType);
    }
    ...
    public void rowTypeIsNull() {
        ...
        new Aggregate_Partial(input, 1, REGISTRY, TestRegistry.FUNC_NAMES, null);
    }
    ...
    public void noSuchFunction() {
        ...
        new Aggregate_Partial(input, 1, REGISTRY, Arrays.asList("this_method_does_not_exist"), rowType);
    }
    ...
    public void inputsIndexTooLow() {
        ...
        new Aggregate_Partial(input, -1, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    }
    ...
    public void inputsIndexTooHigh() {
        ...
        new Aggregate_Partial(input, 2, REGISTRY, TestRegistry.FUNC_NAMES, rowType);
    }
    ...
    private static AggregatorRegistry REGISTRY = new TestRegistry();

    // nested classes

    private static class TestRegistry implements AggregatorRegistry {
        @Override
