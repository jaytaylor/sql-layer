...
public class DecisionEngineTest {
    ...
    public void testTemporaryHack() throws Exception {
        ...
        assertEquals(Decider.RowCollectorType.PersistitRowCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.PersistitRowCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.PersistitRowCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.PersistitRowCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.PersistitRowCollector, de.makeDecision(request, rowDef));
        ...
        assertEquals(Decider.RowCollectorType.VCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.VCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.VCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.VCollector, de.makeDecision(request, rowDef));
        assertEquals(Decider.RowCollectorType.VCollector, de.makeDecision(request, rowDef));
