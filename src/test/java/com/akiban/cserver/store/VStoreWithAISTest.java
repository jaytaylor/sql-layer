...
public class VStoreWithAISTest extends TestCase implements
		CServerConstants {
	...
	public void testDropTable() throws Exception {
		...
		td.insertTestRows();
		Volume volume = ((PersistitStore)store.getHStore()).getDb().getVolume(PersistitStore.VOLUME_NAME);
		...
		assertTrue(((PersistitStore)store.getHStore()).getTableManager()
