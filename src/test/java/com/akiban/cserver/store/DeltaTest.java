...
public class DeltaTest {
    ...
    /**
     * Test method for {@link com.akiban.cserver.store.Delta#Delta(com.akiban.cserver.store.Delta.Type, 
     *                  com.persistit.KeyState, com.akiban.cserver.RowDef, com.akiban.cserver.RowData)}
     */
    @Test
    public void testDelta() {
       ...
       String VCOLLECTOR_DDL = "src/test/resources/vcollector_test-1.ddl";
        ...
        RowDef rdef = rowDefCache.getRowDef(new String("toy_test.great_grandparent"));
        assert rdef != null;
