...
public class SubStringIndexExpressionTest extends ComposedExpressionTestBase 
{
    ...
    public void testRegular()
    {
        ...
        Expression top = new SubStringIndexExpression(getExp("www.mysql.com"), getExp("."), num);
    ...
    {
        Expression num = new LiteralExpression(AkType.INT, 3);
        Expression top = new SubStringIndexExpression(getExp("www.mysql.com"), getExp("."), num);
        ValueSource source = top.evaluation().eval();
    ...
    {
     Expression num = new LiteralExpression(AkType.INT, 4);
        Expression top = new SubStringIndexExpression(getExp("www.mysql.com"), getExp("."), num);
        ValueSource source = top.evaluation().eval();
    ...
    {
        Expression num = new LiteralExpression(AkType.INT, 1);
        Expression top = new SubStringIndexExpression(getExp("www.mysql.com"), getExp("my"), num);
        ValueSource source = top.evaluation().eval();
    ...
    {
        Expression num = new LiteralExpression(AkType.INT, -1);
        Expression top = new SubStringIndexExpression(getExp("www.wysql.com"), getExp("my"), num);
        ValueSource source = top.evaluation().eval();
    ...
    {
        Expression num = new LiteralExpression(AkType.INT, 2);
        Expression top = new SubStringIndexExpression(getExp("www.mysql.com"), getExp("w"), num);
        ValueSource source = top.evaluation().eval();
    ...
    public void testNull()
    {
        ...
        Expression top = new SubStringIndexExpression(arg, arg, arg);
