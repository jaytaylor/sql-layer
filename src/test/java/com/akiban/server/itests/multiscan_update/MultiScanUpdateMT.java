...
public final class MultiScanUpdateMT extends ApiTestBase {
    ...
    public void updateWithMultiScans() throws InvalidOperationException {
        Iterator<NewRow> scanIterator = new ScanIterator(100, scanAllRequest(tableId));
        ...
        while (scanIterator.hasNext()) {
            ...
            int id = get(oldRow, 0, Integer.class);
    ...
    private class ScanIterator implements Iterator<NewRow> {
        ...
        ScanIterator(int bufferSize, ScanRequest request) throws InvalidOperationException {
