 ...
 * <code><pre>
CREATE PROCEDURE test_direct(IN n BIGINT) LANGUAGE java PARAMETER STYLE akiban_loadable_plan EXTERNAL NAME 'com.akiban.server.test.it.routines.TestDirectPlan';
CALL test_direct(10)
 * </pre></code> 
 */
