...
CREATE PROCEDURE test.add_sub(IN n BIGINT) LANGUAGE java PARAMETER STYLE java EXTERNAL NAME 'testjar:com.akiban.server.test.it.routines.TestJavaBasic.addSub';
