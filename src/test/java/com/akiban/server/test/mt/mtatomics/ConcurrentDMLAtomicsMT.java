    ...
    public void updateUnIndexedColumnWhileScanning() throws Exception {
        ...
        TimedCallable<Void> updateCallable = new TimedCallable<Void>() {
            ...
            protected Void doCall(TimePoints timePoints, Session session) throws Exception {
                ...
                dml().updateRow(new Session(), old, updated, new SetColumnSelector(1));
    ...
    public void updatePKColumnWhileScanning() throws Exception {
        ...
        TimedCallable<Void> updateCallable = new TimedCallable<Void>() {
            ...
            protected Void doCall(TimePoints timePoints, Session session) throws Exception {
                ...
                Timing.sleep(2000);
                timePoints.mark("UPDATE: IN");
                dml().updateRow(new Session(), old, updated, new SetColumnSelector(0));
                timePoints.mark("UPDATE: OUT");
                return null;
            }
        };
...
//        scanCallable = TransactionalTimedCallable.withoutRunnable(scanCallable);
        ...
        TimedCallable<Void> updateCallable = new TimedCallable<Void>() {
            ...
            protected Void doCall(TimePoints timePoints, Session session) throws Exception {
                ...
                Timing.sleep(2000);
                timePoints.mark("UPDATE: IN");
                dml().updateRow(new Session(), oldSnowman, updatedSnowman, new SetColumnSelector(1));
                dml().updateRow(new Session(), oldMr, updatedMr, new SetColumnSelector(1));
                timePoints.mark("UPDATE: OUT");
                return null;
            }
        };
...
//        scanCallable = TransactionalTimedCallable.withoutRunnable(scanCallable);
        ...
        TimedCallable<Void> updateCallable = new TimedCallable<Void>() {
            ...
            protected Void doCall(TimePoints timePoints, Session session) throws Exception {
                ...
                Timing.sleep(2000);
                timePoints.mark("UPDATE: IN");
                dml().updateRow(new Session(), oldSnowman, updatedSnowman, new SetColumnSelector(0, 1));
                dml().updateRow(new Session(), oldMr, updatedMr, new SetColumnSelector(1));
                timePoints.mark("UPDATE: OUT");
                return null;
            }
