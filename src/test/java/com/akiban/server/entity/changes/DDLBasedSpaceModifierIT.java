...
public final class DDLBasedSpaceModifierIT extends ITBase {
    ...
    public void test() throws IOException {
        Space origSpace = Space.readSpace(testName + ORIG_SUFFIX, DDLBasedSpaceModifierIT.class, false);
        loadSpace(origSpace);
        Space updateSpace = Space.readSpace(testName + UPDATE_SUFFIX, DDLBasedSpaceModifierIT.class, false);
