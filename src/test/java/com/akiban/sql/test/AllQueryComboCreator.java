...
/*
 * creates tests trying to create all patterns in a programatic way
 * */
public class AllQueryComboCreator extends GenericCreator implements Runnable {
    ...
    public final String[] DT_PARAMS = { "'2011-01-02'" };
    ...
    protected void close() {
        ...
        try {
            save(path + "test-" + targetArea + "-" + master_counter
                    + ".yaml", master_writer);
        } catch (IOException e) {
