...
public class InsertGeneratorIT extends ITBase {
    ...
    public void testNoPKInsert() {
        ...
        assertEquals(
                "Insert_Returning(INTO c)\n" +
                "  Project_Default(NULL, NULL, _SEQ_NEXT(test, c___akiban_pk_seq))\n" +
                "    ValuesScan_Default([])",
                getExplain(insert, table.getSchemaName())
        );
    }
    ...
    public void testAllTypes() {
        ...
        assertEquals(
            ...
            "  Project_Default(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, _SEQ_NEXT(test, all_types___akiban_pk_seq))\n" +
            "    ValuesScan_Default([])",
            getExplain(insert, table.getSchemaName())
        );
    }
